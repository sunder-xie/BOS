	...
	$.extend($.fn.validatebox.defaults.rules, {
		...
		uniqueId: {
			validator: function(value){
				...
				$.ajax({
					type: "POST",
					url: "${pageContext.request.contextPath }/function_ajaxId.action",
					data: {id:value},
...
<div data-options="region:'center'">
	<form id="functionForm" action="${pageContext.request.contextPath}/function_save" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>父功能点</td>
						<td>
							<input name="parentId" class="easyui-combobox" data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/function_findParentFunction'"/>
						</td>
					</tr>
					<tr>
						<td>描述</td>
						<td>
							<textarea name="description" rows="4" id="description" cols="60"></textarea>
						</td>
					</tr>
					</table>
			</form>
