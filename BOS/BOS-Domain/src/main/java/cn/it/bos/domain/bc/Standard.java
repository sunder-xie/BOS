...
public class Standard  implements java.io.Serializable {
	...
	public String toString() {
		return "Standard [id=" + id + ", user=" + user + ", name=" + name + ", minweight=" + minweight + ", maxweight="
				+ maxweight + ", deltag=" + deltag + ", updatetime=" + updatetime + ", staffs=" + staffs + "]";
	}
	...
	private String id;
     ...
     private String deltag="1"; //默认有有效，1：有效 ；0：无效
