...
<body>
	...
	<div class="main-inner" id="mainCnt"
		...
		<div id="loginBlock" class="login"
			...
			<div class="loginForm">
					<div align="center" style="color: red; size: 5px;" >
						    <s:actionerror/>
					</div>
					<s:form namespace="/" action="login" id="loginform" name="loginform" method="post" cssClass="niceform" theme="simple" target="_top">
